...
public sealed class LabelClassRow : BindableBase
{
    ...
    /// <summary>검출 번호. 라벨 파일에 들어가는 그 번호다. 화면에는 안 보인다.</summary>
    public int Index { get; }

    /// <summary>검출 이름. 그리드 칸에서 고쳐 쓴다(더블 클릭).</summary>
    public string Name
    {
        get => GetValue<string>();
        set => SetValue(value);
