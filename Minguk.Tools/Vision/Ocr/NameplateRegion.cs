...
/// <summary>
/// 몹 사각형에서 머리 위 이름표가 있을 자리를 잡는다.
/// </summary>
/// <remarks>
/// 게임은 대개 몹 바로 위에 이름·체력 바를 띄운다. 검출은 몸통만 감싸므로 그 위를 따로 잘라야
/// 글자가 들어온다. 사각형 높이의 45%만큼 위로, 너비는 1.8배(이름이 몸통보다 길다)로 잡고
/// 사각형 위쪽 5% 는 겹치게 둔다 - 라벨이 몹 정수리에 살짝 걸치는 경우가 많다.
...
public static class NameplateRegion
{
    ...
    /// <summary>몹 사각형(0~1) 위의 이름표 자리(0~1). 화면 밖으로는 안 나간다. 너무 작으면 비어 있다.</summary>
