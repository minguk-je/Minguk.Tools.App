...
public static class ScriptApiCatalog
{
    ...
    [
        ...
        new("ReadText", "읽기", "x, y, width, height", "그 자리(0~1 비율)의 글자를 읽는다. 읽기(\"이름\") 으로 화면에서 만들어 둔 자리를 부를 수도 있다.", ScriptApiMode.Live),
        new("ReadNumber", "숫자읽기", "x, y, width, height", "그 자리의 글자에서 숫자만 뽑는다. 숫자읽기(\"이름\") 으로 화면에서 만들어 둔 자리를 부를 수도 있다. 없으면 null.", ScriptApiMode.Live),
